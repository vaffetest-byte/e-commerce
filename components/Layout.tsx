  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50">
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between px-8 py-10">
            <div className="flex flex-col">
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.4em] opacity-40 mt-1">Control Console</span>
            </div>
          ...
          <div className="p-6">
            ...
            <button 
              onClick={onLogout}
              className="w-full flex items-center justify-center gap-3 px-4 py-4 text-rose-400 hover:bg-rose-500 hover:text-white rounded-2xl transition-all font-black text-[10px] uppercase tracking-widest"
            >
              <LogOut size={18} />
              Terminate Session
            </button>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        {/* Header */}
        <header className="h-24 bg-white/80 backdrop-blur-xl border-b border-slate-100 flex items-center justify-between px-10 sticky top-0 z-[100]">
          <div className="flex items-center gap-6">
            <button className="lg:hidden p-3 bg-slate-50 text-slate-900 rounded-2xl" onClick={() => setSidebarOpen(true)}>
              <Menu size={24} />
            </button>
            <div className="hidden md:flex items-center gap-4 bg-slate-50 border border-slate-100 px-6 py-3 rounded-2xl w-[400px] focus-within:ring-4 focus-within:ring-rose-500/5 focus-within:bg-white transition-all group">
          ...
          <div className="flex items-center gap-8">
            <div className="hidden sm:flex flex-col items-end">
                ...
                <span className="text-[9px] font-bold text-slate-300 tracking-widest uppercase">{user.role.replace('_', ' ')}</span>
            </div>
        ...
        {/* Viewport content */}
        <main className="flex-1 overflow-y-auto p-10 lg:p-16 scroll-smooth bg-[#fafafa]">
